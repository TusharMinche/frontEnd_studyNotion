...
function Navbar() {
  ...
  return (
    <div className="navbarContainer">
      <div className="flex items-center justify-center bg-richblack-900 border-b-[1px] border-b-richblack-800" >
              ...
              {!token && (
                <div className="flex flex-col md:flex-row items-center md:items-start gap-y-4 md:gap-y-0 md:gap-x-4">
                  <Link to="/login" onClick={closeMobileMenu}>
                    <button className="rounded-[8px] px-4 py-2 bg-blue-800 text-white  transition duration-300 hover:bg-blue-700 hover:text-gray-200">Log in</button>
                  </Link>
                  <Link to="/signup" onClick={closeMobileMenu}>
                    <button className="rounded-[8px] px-4 py-2 bg-blue-800 text-white transition duration-300 hover:bg-blue-700 hover:text-gray-200">Sign up</button>
                  </Link>
                </div>
              )}
